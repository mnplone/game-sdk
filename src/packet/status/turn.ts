...
import { m1DemoPacketStatusTurnMovementSchema } from './turn/movement.js';
...
export const valiM1DemoPacketStatusTurnSchema = v.pipe(
	v.object({
...
>;
export type M1DemoPacketStatusTurnActionType = SetElement<
