...
export const valiM1DemoPacketTimeSchema = pipe(
	object({
...
export type M1DemoPacketTime = InferOutput<typeof valiM1DemoPacketTimeSchema>;

// -------------------------------------------------
// --------------- TRANSFORM FROM V1 ---------------
// -------------------------------------------------

export const valiM1DemoPacketV1TimeSchema = union([
	// new format
	object({
