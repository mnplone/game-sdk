...
const require_config = require("./config-u3MvC0L5.cjs");
...
const valiSchemas$19 = [valibot.object({
	id: valibot.string(),
...
const m1DemoMovementSchema = valibot.object({
...
const valiSchemas$18 = [valibot.object({
	id: valibot.string(),
...
const valiV1Schemas$18 = [valibot.pipe(valibot.object({
	_id: valibot.optional(valibot.string()),
...
const valiM1DemoPacketStatusTurnSchema = valibot.object({
	...
	movement: valibot.optional(valibot.pipe(m1DemoMovementSchema, valibot.transform((value) => {
...
var M1LiveDemo = class {
	...
	process(value) {
		...
		switch (this.packet_version) {
			case 2:
				packet_raw = require_config.parse(valiM1DemoRawPacketSchema, value);
				break;
			case 1:
				packet_raw = require_config.parse(valiM1DemoRawPacketV1Schema, value);
				break;
